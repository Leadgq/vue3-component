import { g as O, c as d } from "./index-DaZtBBVu.js";
function A(f, v) {
...
(function(f, v) {
  (function(l, r) {
    ...
    var a = typeof window == "object" && window.window === window ? window : typeof self == "object" && self.self === self ? self : typeof d == "object" && d.global === d ? d : void 0, y = a.navigator && /Macintosh/.test(navigator.userAgent) && /AppleWebKit/.test(navigator.userAgent) && !/Safari/.test(navigator.userAgent), p = a.saveAs || (typeof window != "object" || window !== a ? function() {
      ...
      t = t || e.name || "download", n.download = t, n.rel = "noopener", typeof e == "string" ? (n.href = e, n.origin === location.origin ? c(n) : s(n.href) ? r(e, t, i) : c(n, n.target = "_blank")) : (n.href = o.createObjectURL(e), setTimeout(function() {
      ...
      if ((b || n && g || y) && typeof FileReader < "u") {
        ...
        m.onloadend = function() {
          var u = m.result;
          u = b ? u : u.replace(/^data:[^;]*;/, "data:attachment/file;"), o ? o.location.href = u : location = u, o = null;
        }, m.readAsDataURL(e);
      } else {
